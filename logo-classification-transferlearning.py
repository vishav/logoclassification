...
train_logosonly_filename_list = base_logos_dir+"train/filelist.txt"
...
config_file = "./logo-classification-config.ini"
...
def create_val_from_train_dataset(logosonly_filename, val_logo_total):
...
def read_config_values():
    ...
    ctx = [mx.gpu(i) for i in range(num_cpu)]
...
if __name__=="__main__":
    ...
    train_filenames, val_filenames = create_val_from_train_dataset(logosonly_filename=train_logosonly_filename, val_logo_total=233)
    ...
    # print(len(train_imgs.synsets))
    # print(len(val_imgs.synsets))
    # print(len(test_imgs.synsets))
    # print(len(train_filenames), len(val_filenames), len(test_filenames))
    ...
    train(finetune_net, ctx, train_data_loader, val_data_loader, test_data_loader, batch_size, num_epochs, model_prefix='ft')
